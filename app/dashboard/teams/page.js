...
export default async function BrowseTeamsPage({ searchParams }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-text-primary">Browse Teams</h1>
        <p className="mt-1 text-sm text-text-secondary">
          Find teams with open positions across Europe
        </p>
      </div>
      ...
      {sorted.length > 0 ? (
        ...
        <div className="rounded-2xl border border-dashed border-border py-16 text-center">
          ...
          <p className="mt-3 text-sm text-text-muted">No teams match your filters</p>
