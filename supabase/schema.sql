...
-- Participant check is security definer to avoid RLS recursion;
-- conversations are only created through the RPC below, which
-- inserts both participants in one controlled transaction.
-- ----------------------------------------------------------
